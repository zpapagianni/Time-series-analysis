...
We begin by loading our data and converting it to a time series using the ``as.ts()`` function. Then we plot our data.
>>>>>>> 10c5854fccc995fe51f34a9d8f6989ec7c6d55c9
```{r,echo=FALSE}
...
## Parameters of the linear trend component
...
Our time series is clearly seasonal and more complicated than what is captured by a simple AR(1) model. A more appropriate test would be the augmented Dickey Fuller test which was developed for general ARMA(p, q) models
